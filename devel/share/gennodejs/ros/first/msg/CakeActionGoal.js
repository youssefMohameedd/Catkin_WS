...
class CakeActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = CakeGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CakeActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = CakeGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new CakeGoal()
    }
