...
(cl:defclass <CounterActionFeedback> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (feedback
    :reader feedback
    :initarg :feedback
    :type first-msg:CounterFeedback
    :initform (cl:make-instance 'first-msg:CounterFeedback)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <CounterActionFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CounterActionFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name first-msg:<CounterActionFeedback> is deprecated: use first-msg:CounterActionFeedback instead.")))
